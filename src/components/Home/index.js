...
class Home extends Component {
  state = {
    username: '',
    imageUrl:
      'https://res-console.cloudinary.com/dxyggtax2/thumbnails/v1/image/upload/v1718067423/R3JvdXBfMl9neDcyZms=/drilldown',
    err: '',
  ...
  githubApi = async () => {
    ...
    if (promise.ok === false) {
      ...
      this.setState({
        ...
        imageUrl:
          'https://res.cloudinary.com/dxyggtax2/image/upload/v1717936092/error_view_wd2ahc.jpg',
        username: '',
      })
  ...
  getFailureView = () => {
    const {imageUrl, username, err} = this.state
    return (
      <>
        <div className="input-cont">
          <input
        ...
        <h1 className="home-head">GitHub Profile Visualizer</h1>
        <img className="home-login-img" alt="error" src={imageUrl} />
        <p className="err-retry">Somthing went wrong, Please try again</p>
        ...
        <div className="home-search success-input">
          ...
          <div className="profile-cont">
            ...
            <div className="company-url">
              <p className="locate-title">Company Url</p>
              <div className="at-company">
                <IoMdLink className="bulid-icon" />
                <p>{blog}</p>
              </div>
